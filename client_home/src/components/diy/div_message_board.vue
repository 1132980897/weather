<template>
	<div class="diy_details_box diy_div_message_board">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/message_board/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			change_collect() {
				...
				var query = {
					...
					source_field: "message_board_id",
					source_id: this.obj["message_board_id"],
					user_id
				};
      ...
      check_collect() {
        ...
        var message_board_id = this.obj.message_board_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "message_board",
          source_field: "message_board_id",
          source_id: message_board_id
        }, (res) => {
