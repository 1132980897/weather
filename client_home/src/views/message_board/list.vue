<template>
	<div class="diy_list page_message_board" id="message_board_list">
		<div class="warp">
...
<script>
	import list_message_board from "@/components/diy/list_message_board.vue";
